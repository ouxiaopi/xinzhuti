...
$options = array (
	...
	array("name" => "首页文章分类设置","type" => "heading","desc" => "（不能留空）"),
	array("name" => "幻灯分类","id" => $shortname."_cat00","std" => "","type" => "text"),
	array("name" => "幻灯左下分类","id" => $shortname."_cat01","std" => "","type" => "text"),
	array("name" => "幻灯右下分类","id" => $shortname."_cat02","std" => "","type" => "text"),
	array("name" => "默认封面图片设置","type" => "heading","desc" => "（不能留空）"),
